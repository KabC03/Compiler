...
typedef enum TOKEN_ENUM : int {
	...
	TOK_INVALID = -6,
	TOK_EOF = -7,
	TOK_KEYWORD_CHAR = 0,       //0 ::  chr
	TOK_KEYWORD_INT = 1,        //1 ::  int
	TOK_KEYWORD_FLOAT = 2,      //2 ::  flt
	...
	TOK_SYMBOL_COMMA = 18,       //18 ::  ,
	TOK_SEMICOLON = 19,          //19 ::  ;
	TOK_SYMBOL_REFERENCE = 20,   //20 ::  #
	TOK_SYMBOL_DEREFERENCE = 21, //21 ::  @
	TOK_BRACE_OPEN_PAREN = 22,   //22 ::  (
	TOK_BRACE_CLOSE_PAREN = 23,  //23 ::  )
	TOK_BRACE_OPEN_CURLEY = 24,  //24 ::  {
	TOK_BRACE_CLOSE_CURLEY = 25, //25 ::  }
	TOK_BRACE_OPEN_SQUARE = 26,  //26 ::  [
	TOK_BRACE_CLOSE_SQUARE = 27, //27 ::  ]
	TOK_BRACE_OPEN_ANGLE = 28,   //28 ::  <
	TOK_BRACE_CLOSE_ANGLE = 29,  //29 ::  >
} TOKEN_ENUM;
